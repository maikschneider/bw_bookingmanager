plugin.tx_bwbookingmanager_pi1;
{
    view;
    {
        ...
        bw_bookingmanager / Resources / Private / Templates /
            templateRootPaths;
        .1 = { $plugin: .tx_bwbookingmanager_pi1.view.templateRootPath };
        partialRootPaths;
        .0 = EXT;
        bw_bookingmanager / Resources / Private / Partials /
            partialRootPaths;
        .1 = { $plugin: .tx_bwbookingmanager_pi1.view.partialRootPath };
        layoutRootPaths;
        .0 = EXT;
        bw_bookingmanager / Resources / Private / Layouts /
            layoutRootPaths;
        .1 = { $plugin: .tx_bwbookingmanager_pi1.view.layoutRootPath };
    }
    persistence;
    {
